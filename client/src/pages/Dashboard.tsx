...
export default function Dashboard() {
  ...
  const availableWidgets: WidgetConfig[] = useMemo(() => [
        ...
        <TechnicalIndicatorsWidget
          marketData={(() => {
            ...
            if (historicalData.length > 0) {
              ...
              const syntheticData = [];
              for (let i = 0; i < 50; i++) {
                const timeAgo = Date.now() - (i * 60000);
    ...
    removeWatchlistMutation, handleSelectToken, aggregatedMarketData, aggregatedOrderBook,
    orderBookViewMode, chartSymbol, chartTimeframe, chartType, chartCandles,
    marketData, webhookMessages, toggleBookmarkMutation, alerts,
          ...
          <div className="mb-4 flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
                ...
                onChange={(e) => {
                  ...
                  if (file) {
                    ...
                    reader.onload = (evt) => {
                      ...
                      importTabs(jsonString);
                      toast({
                        title: "Tabs Imported",
                        description: "Dashboard tabs have been imported successfully"
                      });
                    };
              ...
              <Button
                ...
                size="sm"
                onClick={() => {
                  const dataStr = exportTabs();
                  const blob = new Blob([dataStr], { type: 'application/json' });
                  const url = URL.createObjectURL(blob);
                  const link = document.createElement('a');
                  link.href = url;
                  link.download = 'dashboard-tabs.json';
                  link.click();
                  URL.revokeObjectURL(url);
                  toast({
                    title: "Tabs Exported",
                    description: "Dashboard tabs saved to file"
                  });
                }}
                className="gap-2"
              ...
              <Button
                ...
                className="gap-2"
                data-testid="button-import-tabs"
              >
